...
ktType (BT_List element) = "java.util.LinkedList<" <>> elementTypeName element <<> ">"
ktType (BT_Vector element) = "java.util.ArrayList<" <>> elementTypeName element <<> ">"
ktType (BT_Set element) = "java.util.HashSet<" <>> elementTypeName element <<> ">"
ktType (BT_Map key value) = "java.util.HashMap<" <>> elementTypeName key <<>> ", " <>> elementTypeName value <<> ">"
